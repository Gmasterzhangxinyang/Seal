...
def upgrade() -> None:
    ...
    op.create_table('template_fields',
        ...
        sa.Column('template_id', sa.Integer,
                  sa.ForeignKey('doc_templates.id', ondelete='CASCADE'), nullable=False),
        sa.Column('field_name', sa.String(100), nullable=False),
        sa.Column('field_label', sa.String(100), nullable=False),
        sa.Column('field_category', sa.String(20), nullable=False, server_default='required'),
        sa.Column('ocr_pattern', sa.Text),
        sa.Column('validation_rule', sa.Text),
        sa.Column('sort_order', sa.Integer, server_default='0'),
    )

    op.create_table('template_examples',
        sa.Column('id', sa.Integer, primary_key=True, autoincrement=True),
        sa.Column('template_id', sa.Integer,
